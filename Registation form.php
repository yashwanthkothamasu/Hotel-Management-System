...
include('Menu Bar.php');
  ?>
<div class="container-fluid"style="background-color:#AED6F1;color:#000;"> <!-- Primary Id-->
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6 ">
        ...
        <div class="form-group">
          ...
          <div class="row">
            ...
            <input type="submit" value="Submit" name="save"class="btn btn-success btn-group-justified"required style="color:#000;background-color:#2E86C1;font-family: 'Baloo Bhai', cursive;height:40px;"/>
          </div>
          </div>
          </div>
        </form>
