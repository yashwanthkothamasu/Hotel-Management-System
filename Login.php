  ...
  <div class="container">
    <div class="row"><br>
      <div class="col-sm-4"></div>
        <div class="col-sm-4 text-center"style="box-shadow:2px 2px 2px;background-color:#AED6F1;"><br>

        	<h1 align="center"><b><font style="font-family: 'Times New Roman', serif;">User Login</font></b></h1>
